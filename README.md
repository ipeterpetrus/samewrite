...
| **A terse-output mode that IS always on** | **−22.4% output tokens**, net **+$14.68**/1k tasks on Opus 5 — but its own claim is −65% | 36 runs, treatment verified 12/12; beats a one-sentence placebo by 9.2%, p = 0.039 |
